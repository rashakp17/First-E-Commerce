...
const OrderSummary = () => {
  ...
  return (
    <div className='mt-4 flex flex-col gap-3 mr-20'>
      <h2 className='text-white font-opensans text-lg mb-4'>ORDER SUMMARY</h2>
              {cartItems.map((item,idx)=>
              <div key={idx} className='flex flex-row  gap-20'>
                <span className='text-white text-sm'>Product {idx + 1} x {item.quantity}</span>
